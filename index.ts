                          ...
                          < script src = "https://cdnjs.cloudflare.com/ajax/libs/exceljs/4.3.0/exceljs.min.js" > </script>
                            < script src = "https://cdn.tailwindcss.com" > </script>
                              ...
                              < !--Premium Google Fonts-- >
                                <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800&family=Manrope:wght@500;700;800&display=swap"
rel = "stylesheet" >
...
#appContent {
  font - family: -apple - system, BlinkMacSystemFont, 'Inter', sans - serif;
        ...
        .font - display,
  #totalPrice,
  #statAdl, #statChld, #statInf, #statPens, #statInv, #statBday {
...
#appContent.text - cyan - 100, #appContent.text - cyan - 200, #appContent.text - cyan - 300, #appContent.text - cyan - 400,
  #appContent.text - teal - 100, #appContent.text - teal - 200, #appContent.text - teal - 300, #appContent.text - teal - 400 {
  color: #0f766e!important;
}

#appContent.text - blue - 100, #appContent.text - blue - 200, #appContent.text - blue - 300, #appContent.text - blue - 400 {
  color: var(--brand - dark)!important;
}

#appContent.text - emerald - 100, #appContent.text - emerald - 200, #appContent.text - emerald - 300, #appContent.text - emerald - 400,
  #appContent.text - green - 100, #appContent.text - green - 200, #appContent.text - green - 300, #appContent.text - green - 400 {
  color: #047857!important;
}

#appContent.text - purple - 100, #appContent.text - purple - 200, #appContent.text - purple - 300, #appContent.text - purple - 400 {
  color: #6d28d9!important;
}

#appContent.text - rose - 100, #appContent.text - rose - 200, #appContent.text - rose - 300, #appContent.text - rose - 400 {
  color: #be123c!important;
}

#appContent.text - amber - 100, #appContent.text - amber - 200, #appContent.text - amber - 300, #appContent.text - amber - 400,
  #appContent.text - yellow - 100, #appContent.text - yellow - 200, #appContent.text - yellow - 300, #appContent.text - yellow - 400 {
...
body.dark - mode #appContent #authScreen { /* no-op guard, kept for clarity */ }
  ...
  display: none;
        ...
        .pill - emerald { background - color: #10b981!important; color: white!important; font - weight: bold; border - radius: 999px; }
        .pill - cyan { background - color: var(--aqua)!important; color: white!important; font - weight: bold; border - radius: 999px; }
        .pill - amber { background - color: var(--sun)!important; color: white!important; font - weight: bold; border - radius: 999px; }
        .pill - rose { background - color: #f43f5e!important; color: white!important; font - weight: bold; border - radius: 999px; }
        .pill - slate { background - color: #64748b!important; color: white!important; font - weight: bold; border - radius: 999px; }
...
@keyframes bubble - rise {
  ...
  100 % { transform: translateY(-100px) scale(1.2); opacity: 0; }
        ...
        .date - left - align:: -webkit - date - and - time - value { text - align: left!important; }
        .date - left - align:: -webkit - datetime - edit { text - align: left!important; padding: 0; }
input[type = "date"]:: -webkit - date - and - time - value { text - align: left!important; }
input[type = "date"]:: -webkit - datetime - edit { text - align: left!important; display: block; padding: 0; }
...
@keyframes row - fade - out {
            from { opacity: 1; transform: translateY(0) scale(0.98); }
...
class="fa-solid fa-dolphin absolute -top-2 -right-1 text-cyan-300 text-lg transform rotate-45 opacity-80 scale-x-[-1]" > </i>
  < h2 class="font-display text-3xl md:text-4xl font-black text-white tracking-wider text-glow mt-2" > TETYS BLUE </h2>
    </div>
...
class="text-xs text-rose-400 font-semibold mt-1.5 hidden drop-shadow-sm" >
  <i class="fa-solid fa-triangle-exclamation mr-1" > </i>Тариф не найден</p >
    </div>
  ...
  < !--Top row: Итоговый расчет + Сводная статистика на одном уровне-- >
    <div class="grid grid-cols-1 xl:grid-cols-12 gap-6 items-stretch" >
      ...
      <!--Calculated Estimate Summary-- >
        <section
                                class="xl:col-span-6 neon-card-blue p-5 md:p-6 rounded-2xl relative overflow-hidden shadow-sm border border-blue-500/20 flex flex-col justify-between gap-5" >
...
opacity = "0.5" />
  ...
  < !--Eyebrow -->
    <div class="relative z-10 flex items-center gap-2 flex-wrap" >
      <span
                                        class="text-blue-200 text-[10px] font-bold uppercase tracking-widest block" > Итоговый
расчет </span>
...
class="hidden bg-amber-400 text-slate-900 text-[8px] font-extrabold px-1.5 py-0.5 rounded-full shadow-md animate-pulse" >
  <i class="fa-solid fa-bolt mr-0.5" > </i> -15%
    ...
    < !--Hero price — the dominant element of the card-- >
      <div class="relative z-10 flex items-baseline gap-2" >
        <span
                                        class="font-display text-[40px] md:text-[48px] leading-none font-extrabold text-white tracking-tight drop-shadow-md"
id = "totalPrice" > 0 </span>
  < span class="text-lg md:text-xl font-black text-amber-300 drop-shadow-sm" >₸</span>
    </div>

    < div class="relative z-10 border-t border-white/10" > </div>

      < !--Actions: one primary(WhatsApp), two secondary-- >
        <div class="relative z-10 flex flex-col gap-2" >
          <button id="whatsappShareBtn" style = "color:#fff"
class="w-full justify-center bg-emerald-500 hover:bg-emerald-400 font-bold px-4 py-3 rounded-xl text-[13px] flex items-center gap-2 transition-all shadow-md shadow-emerald-500/20"
title = "Отправить в WhatsApp" >
  <i class="fa-brands fa-whatsapp text-base" > </i> Отправить в WhatsApp
    </button>
    < div class="grid grid-cols-2 gap-2" >
      <button id="downloadReceiptBtn"
class="justify-center bg-white/10 hover:bg-white/20 font-semibold px-3 py-2.5 rounded-xl text-[12px] flex items-center gap-1.5 transition-all border border-white/10"
title = "Скачать PDF чек" >
  <i class="fa-solid fa-cloud-arrow-down text-sm" > </i> Скачать
    </button>
    < button id = "nativeShareBtn"
class="justify-center bg-white/10 hover:bg-white/20 font-semibold px-3 py-2.5 rounded-xl text-[12px] flex items-center gap-1.5 transition-all border border-white/10"
title = "Поделиться чеком" >
  <i class="fa-solid fa-share-nodes text-sm" > </i> Поделиться
    </button>
    </div>
    </div>
    </section>
  ...
  <h2 class="font-display text-sm font-bold text-white flex items-center drop-shadow-md mb-2" >
